...
**Description**: Create a calendar booking app. Users should be able to register to events, and be able to pay for attending them (using stripe). There should also be an admin page where an admin can create events for specific dates and times. 
...
```sh
git clone https://github.com/GPT-Engineer-App/bookify-hub.git
cd bookify-hub
npm i
